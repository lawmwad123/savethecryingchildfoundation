...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white">Learn about our journey, mission, and the team behind Save the Crying Child Foundation.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-semibold mb-6 text-[#c0392b]">Our Story</h2>
      ...
      <section className="py-16 bg-[#f8f3eb]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-semibold mb-12 text-[#c0392b]">Our Mission & Vision</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-4 text-[#c0392b]">Our Mission</h3>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-4 text-[#c0392b]">Our Vision</h3>
                <p className="text-gray-700">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold mb-12 text-center text-[#c0392b]">Our Core Values</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-[#f8f3eb] p-6 rounded-lg shadow-md text-center">
              <div className="w-14 h-14 mx-auto mb-4 bg-[#e74c3c] rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-[#c0392b]">Compassion</h3>
            ...
            <div className="bg-[#f8f3eb] p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#c0392b]">Community</h3>
            ...
            <div className="bg-[#f8f3eb] p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#c0392b]">Integrity</h3>
            ...
            <div className="bg-[#f8f3eb] p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#c0392b]">Empowerment</h3>
      ...
      <section className="py-16 bg-[#f8f3eb]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold mb-12 text-center text-[#c0392b]">Our Journey</h2>
          
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 h-full w-1 bg-[#e74c3c]"></div>
                ...
                <div key={event.year} className={`mb-8 flex flex-col md:flex-row ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                  <div className="md:w-1/2 p-4">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                      <div className="text-xl font-bold text-[#e74c3c] mb-2">{event.year}</div>
                      <h3 className="text-lg font-semibold mb-2 text-[#c0392b]">{event.title}</h3>
                      <p className="text-gray-700">{event.description}</p>
                    </div>
                  </div>
                  <div className="md:w-1/2 relative flex justify-center items-center">
                    <div className="h-4 w-4 absolute left-[-8px] md:left-auto md:right-[-8px] bg-[#e74c3c] rounded-full border-4 border-white z-10"></div>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold mb-12 text-center text-[#c0392b]">Meet Our Team</h2>
            ...
            {teamMembers.map((member) => (
              <div key={member.name} className="bg-[#f8f3eb] rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#e74c3c] font-medium mb-4">{member.role}</p>
      ...
      <section className="py-16 bg-gradient-to-r from-[#c0392b] to-[#e74c3c] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/donate" className="bg-[#962d22] hover:bg-[#7d261c] text-white px-6 py-3 rounded-full font-medium transition-colors">
              Support Our Work
            </Link>
