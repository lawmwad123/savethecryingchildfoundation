        ...
        <div className="container mx-auto px-4">
          ...
          {activeTab === 'volunteer' && (
            <div className="max-w-4xl mx-auto">
              ...
              {/* Contact Options */}
              <div className="bg-white p-8 rounded-lg shadow-md mb-8">
                <h4 className="text-xl font-semibold mb-4 text-[#c0392b]">Get in Touch</h4>
                <p className="mb-6">
                  To apply as a volunteer, please reach out to us through any of the following channels:
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <a href="mailto:Savethecryingchildrenfdn@gmail.com" className="text-[#e74c3c] hover:text-[#c0392b] transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <a href="https://wa.me/256770610972" target="_blank" rel="noopener noreferrer" className="text-[#e74c3c] hover:text-[#c0392b] transition-colors">
                        WhatsApp: +256 770 610972
                      </a>
                      <a href="https://wa.me/256754903778" target="_blank" rel="noopener noreferrer" className="text-[#e74c3c] hover:text-[#c0392b] transition-colors">
                        WhatsApp: +256 754 903778
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md mt-12">
                <h4 className="text-xl font-semibold mb-6 text-[#c0392b]">Volunteer Application Form</h4>
                <p className="mb-6 text-gray-700">
                  Fill out this form and we'll get back to you, or contact us directly through WhatsApp or email.
                </p>
