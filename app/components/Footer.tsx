...
export default function Footer() {
  return (
    <footer className="bg-[#932327] text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Image 
              ...
              width={180} 
              height={60} 
              className="h-auto bg-white rounded-lg p-2 mb-4"
            />
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-[#c95d63] pb-2">Quick Links</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-[#c95d63] pb-2">Contact Us</h3>
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>123 Hope Street, Kampala, Uganda</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>info@savethecryingchild.org</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-[#c95d63] pb-2">Join Our Newsletter</h3>
            ...
            <form className="space-y-2">
              ...
              <button 
                type="submit" 
                className="w-full bg-[#c95d63] hover:bg-[#f8f3eb] hover:text-[#932327] transition-colors py-2 rounded text-sm font-medium"
              >
                Subscribe
              </button>
            </form>
        ...
        {/* Social Media */}
        <div className="flex justify-center space-x-4 mt-8 pt-6 border-t border-[#c95d63]">
          <a href="https://facebook.com" className="hover:text-[#f8f3eb]" aria-label="Facebook">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
            </svg>
          </a>
          <a href="https://twitter.com" className="hover:text-[#f8f3eb]" aria-label="Twitter">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
            </svg>
          </a>
          <a href="https://instagram.com" className="hover:text-[#f8f3eb]" aria-label="Instagram">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://youtube.com" className="hover:text-[#f8f3eb]" aria-label="YouTube">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
